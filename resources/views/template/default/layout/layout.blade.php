                    ...
                    <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
                        <div class="nav-outer">
                            <ul class="nav navbar-nav">
                                        ...
                                        <li>
                                            <div class="yamm-content">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-4 col-menu custom-banner"> <a href="home.html#"><img alt="" src="/assets/images/banners/banner-side.png"></a> </div>
                                                </div>
                                                <!-- /.row -->
                                            </div>
                                            <!-- /.yamm-content --> </li>
                                ...
                                <li class="dropdown"> <a href="home.html#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">Pages</a>
                                ...
                                <li class="dropdown  navbar-right special-menu"> <a href="home.html#">Todays offer</a> </li>
                            </ul>
                            <!-- /.navbar-nav -->
                            <div class="clearfix"></div>
                        </div>
